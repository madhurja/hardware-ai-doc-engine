...
DOCUMENT_TYPES = ("user_manual", "test_report", "drc_report", "product_brief", "compliance_brief", "bom")
...
ALIASES = {
    ...
    "onepager": "product_brief",
    "one pager": "product_brief",
    "datasheet": "product_brief",
    "data sheet": "product_brief",
    "port map": "product_brief",
